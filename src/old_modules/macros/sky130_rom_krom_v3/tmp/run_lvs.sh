#!/bin/sh
source /workspaces/OpenRAM/miniconda/bin/activate
...
lvs {sky130_rom_krom.spice sky130_rom_krom} {sky130_rom_krom.sp sky130_rom_krom} setup.tcl sky130_rom_krom.lvs.report -full -json
quit
EOF
magic_retcode=$?
